...
if __name__ == '__main__':
    ...
    target_data_1 = sc.read_h5ad("GSE189903_f_N15.h5ad")
    target_data_2 = sc.read_h5ad("GSE151530_f_N18.h5ad")
    ...
    class_weights = {
        'TAMs': 1.5,        # Decrease weight for "T cells"
...
# Initialize a simple baseline model for Cleanlab
    ...
    label_comparison_df.to_csv("label_comparison_3.csv", index=False)
...
# --- 10-Fold Cross-Validation ---
    ...
    for fold, (train_idx, test_idx) in enumerate(kf.split(X_ref, y_ref), 1):
        ...
        model_filename = f"NN_final_2_Cleanlab_125449_fold_{fold}.h5"
    ...
    def add_predictions_to_adata(model, data, unique_labels, filename):
        ...
        data.obs['GSE125449_NN'] = predicted_labels
        data.write_h5ad(filename)

    # Save Predictions for Target Data
    add_predictions_to_adata(model, target_data_1, unique_labels, "GSE189903_f_N1215.h5ad")
    add_predictions_to_adata(model, target_data_2, unique_labels, "GSE151530_f_N1218.h5ad")
    ...
    plot_confusion_matrix(y_true_1_labels, y_pred_1_labels, unique_labels, "confusion_matrix_target_1_NN_3.png")
    ...
    plot_confusion_matrix(y_true_2_labels, y_pred_2_labels, unique_labels, "confusion_matrix_target_2_NN_3.png")
