...
if __name__ == '__main__':
    ...
    target_data_1 = sc.read_h5ad("GSE189903_f_N1215.h5ad")
    target_data_2 = sc.read_h5ad("GSE125449_f_N1518_R18.h5ad")
    ...
    label_comparison_df.to_csv("label_comparison_5.csv", index=False)
    ...
    for fold, (train_idx, test_idx) in enumerate(kf.split(X_ref, y_ref), 1):
        ...
        model_filename = f"RF_final_2_Cleanlab_151530_fold_{fold}.pkl"
    ...
    def add_predictions_to_adata(model, data, unique_labels, filename):
        ...
        data.obs['GSE151530_RF'] = predicted_labels
        data.write_h5ad(filename)

    # Save Predictions for Target Data
    add_predictions_to_adata(rf_clf, target_data_1, unique_labels, "GSE189903_f_N1218_R15.h5ad")
    add_predictions_to_adata(rf_clf, target_data_2, unique_labels, "GSE125449_f_N1518_R1518.h5ad")
    ...
    plot_confusion_matrix(y_true_1_labels, y_pred_1_labels, unique_labels, "confusion_matrix_target_1_RF_5.png")
    ...
    plot_confusion_matrix(y_true_2_labels, y_pred_2_labels, unique_labels, "confusion_matrix_target_2_RF_5.png")
