...
if __name__ == '__main__':
    ...
    target_data_1 = sc.read_h5ad("GSE189903_filtered.h5ad")
    target_data_2 = sc.read_h5ad("GSE125449_f_N18.h5ad")
    ...
    class_weights = {
        ...
        'B cells': 1.5,
        'Malignant cells': 0.5,  # Decrease weight for "Malignant cells"
    ...
    label_comparison_df.to_csv("label_comparison_2.csv", index=False)
    ...
    for fold, (train_idx, test_idx) in enumerate(kf.split(X_ref, y_ref), 1):
        ...
        model_filename = f"NN_final_2_Cleanlab_151530_fold_{fold}.h5"
    ...
    def add_predictions_to_adata(model, data, unique_labels, filename):
        ...
        data.obs['GSE151530_NN'] = predicted_labels
        data.write_h5ad(filename)

    # Save Predictions for Target Data
    add_predictions_to_adata(model, target_data_1, unique_labels, "GSE189903_f_N15.h5ad")
    add_predictions_to_adata(model, target_data_2, unique_labels, "GSE125449_f_N1518.h5ad")
    ...
    plot_confusion_matrix(y_true_1_labels, y_pred_1_labels, unique_labels, "confusion_matrix_target_1_NN_2.png")
    ...
    plot_confusion_matrix(y_true_2_labels, y_pred_2_labels, unique_labels, "confusion_matrix_target_2_NN_2.png")
